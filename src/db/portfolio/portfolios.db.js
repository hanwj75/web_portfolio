...
export const createPortfolio = async (userId, title) => {
  try {
    ...
    throw new CustomError("포트폴리오 생성 에러", 500);
  }
};
...
export const findUserPortfolios = async (userId) => {
  try {
    ...
    if (err instanceof CustomError) throw err;
    throw new CustomError("사용자의 모든 포트폴리오 조회 에러", 500);
  }
};
...
export const findPortfolioWithSections = async (portfoliosId, userId) => {
  try {
    ...
    if (err instanceof CustomError) throw err;
    throw new CustomError("포트폴리오 상세 조회 에러", 500);
  }
};
...
export const findPortfolioByUUID = async (id) => {
  try {
    ...
    if (err instanceof CustomError) throw err;
    throw new CustomError("포트폴리오 조회 에러", 500);
  }
};
...
export const deployPortfolio = async (id, userId) => {
  try {
    ...
    if (err instanceof CustomError) throw err;
    throw new CustomError("포트폴리오 배포 상태 업데이트 에러", 500);
  }
};
...
export const findPortfolioByPublicUrlId = async (publicUrlId) => {
  try {
    ...
    if (err instanceof CustomError) throw err;
    throw new CustomError("배포된 포트폴리오 조회 에러", 500);
  }
};
...
export const findPortfolioByCategory = async (publicUrlId, categoryId) => {
  try {
    ...
    if (err instanceof CustomError) throw err;
    throw new CustomError("포트폴리오 카테고리별 조회 에러", 500);
  }
};
...
export const findPortfolioSortOrder = async (publicUrlId, sortOrder) => {
  try {
    ...
    if (err instanceof CustomError) throw err;
    throw new CustomError("포트폴리오 sortOrder 조회 에러", 500);
  }
};
...
export const updatePortfolio = async (id, title) => {
  try {
    ...
    if (err instanceof CustomError) throw err;
    throw new CustomError("포트폴리오 수정 에러", 500);
  }
};
...
export const deletePortfolio = async (id) => {
  try {
    ...
    if (err instanceof CustomError) throw err;
    throw new CustomError("포트폴리오 삭제 에러", 500);
  }
};
